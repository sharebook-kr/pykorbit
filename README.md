...
```
>>> resp = korbit.buy_limit_order("ETC", 30000, 0.1)
>>> print(resp)
(184372254, 'success', 'xrp_krw')
```

## Cancel Order 

```
>>> resp = korbit.cancel_order("BTC", 9000)
>>> print(resp)
[{'orderId': '184372254', 'status': 'success', 'currencyPair': 'xrp_krw'}]
```
